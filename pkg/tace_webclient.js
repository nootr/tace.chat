 ...
 */
export function encrypt(my_private_key_hex, their_public_key_hex, plaintext) {
    const ptr0 = passStringToWasm0(my_private_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function decrypt(my_private_key_hex, their_public_key_hex, ciphertext, nonce) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(my_private_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {Uint8Array}
 */
export function sign(private_key_hex, message) {
...
export class EncryptedMessage {
     ...
     */
    get ciphertext() {
        const ret = wasm.__wbg_get_encryptedmessage_ciphertext(this.__wbg_ptr);
    ...
    set ciphertext(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_encryptedmessage_ciphertext(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {Uint8Array}
     */
    get nonce() {
        const ret = wasm.__wbg_get_encryptedmessage_nonce(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
    ...
    set nonce(arg0) {
        const ptr0 = passArray8ToWasm0(arg0, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_encryptedmessage_nonce(this.__wbg_ptr, ptr0, len0);
    }
}
...
export class JsKeypair {
    ...
    get private_key() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_jskeypair_private_key(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get public_key() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_jskeypair_public_key(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('tace_webclient_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
